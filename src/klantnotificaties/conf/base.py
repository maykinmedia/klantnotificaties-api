...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "klantnotificaties"),
        "USER": os.getenv("DB_USER", "klantnotificaties"),
        "PASSWORD": os.getenv("DB_PASSWORD", "klantnotificaties"),
...
ROOT_URLCONF = "klantnotificaties.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "klantnotificaties.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "klantnotificaties.wsgi.application"
...
DEFAULT_FROM_EMAIL = "klantnotificaties@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "klantnotificaties.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    "klantnotificaties.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "klantnotificaties_sessionid"
