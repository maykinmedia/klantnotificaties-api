...
os.environ.setdefault("SECRET_KEY", "django-insecure-#u#u@ip@(@2lm7sa-+k=_ju)%l)xyd9esr@0h0%5c86!n1k!^k")
os.environ.setdefault("DB_NAME", "klantnotificaties")
os.environ.setdefault("DB_USER", "klantnotificaties")
os.environ.setdefault("DB_PASSWORD", "klantnotificaties")
